...
`fix/issue-43-rmcp-3`; draft PR pending creation.
...
- [ ] Revision 2 approved; record evidence and open draft PR.
- [ ] SDK migration, meaningful regression coverage, and implementer acceptance pass.
...
Implementer runtime: pending; explicit user requirement to use MCP as a client.
Reviewer runtime and final review: pending.
Goal status: approved; implementation starting.
PR/release status: not started.
